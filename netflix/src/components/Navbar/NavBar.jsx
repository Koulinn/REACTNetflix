      ...
      <Container fluid>
        <Navbar variant="dark" className="sticky-top bg-color px-0">
          <Navbar.Brand className="p-0">
            <Link to="/"><img src="./assets/netflix_logo.png" className="img-logo h-100" alt=""></img></Link>
          </Navbar.Brand>
          
          <Nav className="mr-auto">
            <Link to="/" className={this.props.location.pathname === '/home'
              ? 'nav-link active'
              : 'nav-link'}>Home
            </Link>
